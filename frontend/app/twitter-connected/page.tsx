...
function TwitterConnectedContent() {
...
function TwitterConnectedFallback() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-background p-6">
      <Card className="w-full max-w-md bg-card border-border">
        <CardContent className="pt-6 text-center space-y-4">
          <div className="flex justify-center">
            <div className="rounded-full bg-success/20 p-4">
              <Loader2 className="h-12 w-12 text-success animate-spin" />
            </div>
          </div>
          <div>
            <h1 className="text-2xl font-bold mb-2">Twitter Connected!</h1>
...
export default function TwitterConnectedPage() {
  return (
    <Suspense fallback={<TwitterConnectedFallback />}>
      <TwitterConnectedContent />
    </Suspense>
  )
}
