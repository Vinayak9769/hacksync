...
const competitors = [
  {
    ...
    postingFrequency: "3.2 posts/day",
    followerGrowth: 12.5,
    followers: "2.4M",
  },
  {
  ...
  },
  {
    ...
    postingFrequency: "1.8 posts/day",
    followerGrowth: -2.1,
    followers: "950K",
  },
]
    ...
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {competitors.map((competitor) => (
          <Card
            key={competitor.id}
            className={`p-4 cursor-pointer transition-all ${selectedCompetitors.includes(competitor.id) ? "ring-2 ring-primary" : ""}`}
            ...
            <div className="space-y-3 text-sm">
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-1">
                  ...
                  <span className={competitor.followerGrowth > 0 ? "text-[hsl(var(--success))]" : "text-destructive"}>
                    {competitor.followerGrowth > 0 ? "+" : ""}
